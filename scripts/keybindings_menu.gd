...
var _sustain_turn_mode_toggle: CheckButton = null
...
func _build_rows() -> void:
	for action in KeybindingsSettings.ACTIONS:
		...
		if action == "sustain_turn_mode":
			_build_sustain_turn_mode_row()

	_build_analog_rows()
	_refresh_labels()


func _build_sustain_turn_mode_row() -> void:
	...
	toggle.set_pressed_no_signal(KeybindingsSettings.sustain_turn_mode_inverted)
	toggle.toggled.connect(_on_sustain_turn_mode_toggled)
	_action_grid.add_child(toggle)
	_sustain_turn_mode_toggle = toggle
...
func _refresh_labels() -> void:
	...
	if _sustain_turn_mode_toggle != null:
		_sustain_turn_mode_toggle.set_pressed_no_signal(KeybindingsSettings.sustain_turn_mode_inverted)
...
func _on_sustain_turn_mode_toggled(button_pressed: bool) -> void:
	KeybindingsSettings.set_sustain_turn_mode_inverted(button_pressed)
